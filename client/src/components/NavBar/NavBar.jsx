...
export default function NavBar(){
    ...
    return(
        <nav className="nav-container">
                <h1 onClick={reload} className="h1-nav">Foody App🍱</h1>
                <form className="form-nav" onSubmit={handleSubmit}>
                    <input className="form-nav-input-text" type="text" placeholder="Buscar recetas..." value={search} onChange={handleChange}/>
            ...
            <Link className="form-nav-link-create" to="/create">Crear Receta👨‍🍳</Link>
        </nav>
    )
}